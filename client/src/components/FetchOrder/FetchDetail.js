...
const SlipDetail = props => {
  const { fetchData, picker, shipper } = props.location.state.detail;
  return (
    <div className="packing-slip">
      <div className="row header pad-top">
        ...
        >
          <br />
          <strong>
            {fetchData.orderCount > 3 ? <p>&#8212;</p> : fetchData.orderCount}
          </strong>
          <br />
      ...
      >
        ...
        <tfoot>
          ...
          <tr>
            ...
            <th style={{ padding: "0 .78571429em", borderTop: "none" }}>
              $-
              {parseFloat(fetchData.bigCommerce.store_credit_amount).toFixed(2)}
            </th>
          </tr>
          <tr>
            <th
